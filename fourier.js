 ...
 */
const cfft = function(amplitudes) {
    ...
    var result = mag(amplitudes);
    return result;
};

function mag(amplitudes) {
    var result = new Array(amplitudes.length);
    for(var i = 0; i < result.length; i++) {
        result[i] = Math.sqrt(amplitudes[i].re*amplitudes[i].re + amplitudes[i].im*amplitudes[i].im);
    }
    return result;
}
